...
#
# Usage:
# python get_stock_data.py start_date=2014-03-01 end_date=2014-04-01 write_to=weekly.2014-03.csv
# This will loop through until end_date.  end_date will not run.
#
# This will run a single day
# python get_stock_data.py start_date=2014-03-01 write_to=weekly.2014-03-01.csv
#
# python get_stock_data.py start_date=2014-05-01 write_to=current.csv
#
